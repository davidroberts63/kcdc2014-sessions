var fridayCourses = [ { course_title: 'How to make your application awesome with JSON, REST and Web API',
  ...
  { course_title: 'C for managed programmers',
    author: 'James Nugent',
    description: 'Many programmers who work in managed languages see C as a scary, long-in-the-tooth relic from the past that should be consigned to the history books. Despite the best efforts of certain platform vendors, C is actually a thriving ecosystem within which you can write efficient, low level and (broadly speaking!) cross platform code.\n\nIn this crash^H^H^H^H^HSIGSEGV course for managed developers we\'ll look at the major hurdles to get started and how understanding some of what\'s going on underneath can help no matter what platform you\'re programming against!',
    going: '',
    time: '2:10pm-3:10pm' },
  { course_title: 'Mastering Angular $scope',
    author: 'Jeremy Mason',
    description: 'We will begin with a brief introduction to the Model-View-Whatever pattern that is used by Angular, before we deep dive into different ways to wire up components and share data throughout your application using $scope.\n\nI will assume that participants are familiar with Javascript syntax and the basic structure of an Angular application. ',
    going: '',
    time: '1pm-2pm' },
  ...
  { course_title: 'Can Professionals Wear Shorts?',
    author: 'Nate Taylor',
    description: 'Software developers are still a relatively new breed of employees. It is often debated whether development is engineering or art. Conversations over whether a developer should go to school, or through an apprenticeship are commonplace.\n\nOne conversation that seems to be missing, however, is what does it mean to be a PROFESSIONAL software developer? Is there any difference between the code a pro writes, and what you write over the weekend?\n\nIn this session we\'ll look at what it means to be a professional software developer. The talk will focus on principles behind being professional, drawing from other disciplines as well as our own.',
    going: '',
    time: '10:50am-11:50am' },
  { course_title: 'Sniffing Out Success: Identifying Smells and Anti-Patterns in Your Code',
    author: 'Patrick Delancy',
    description: 'This presentation reviews some of the most common and dangerous code smells and anti-patterns supported by some debate about why they should be avoided. There will be many examples and a lot of interactive discussion to help illustrate the virtues of identifying anti-patterns in our code and how to fix them.\n\nLearn cool new terms like object orgy, shotgun surgery and contrived complexity! Become a better developer! Impress your friends!',
    going: '',
    time: '3:20pm-4:20pm' },
  ...
  { course_title: 'Advanced JavaScript debugging for Agile developers',
    author: 'Zach Gardner',
    description: 'In Agile, speed is king. JavaScript is becoming one of the most popular languages for Agile projects. The two seem made for each other, except when new code causes a bug. Traditional JavaScript debugging is slow, and can make velocity nose dive.\n\nIn this session, I will explain techniques I\'ve taught to Agile teams that made them more efficient when debugging their JavaScript applications. Some techniques can apply to other languages, some are specific to JavaScript.\n\n1) The Validating Assumptions paradigm\n2) Binary Search\n3) Top-Down and Bottom-Up\n4) debugger statements\n5) Event Listener Breakpoints\n6) Observing Changes - JavaScript Objects and DOM\n7) Reporting bugs',
    going: '',
    time: '3:20pm-4:20pm' },
  { course_title: 'Polyglot Architecture at Groupon: Selling Coupons from the Edge',
    author: 'Dusty Burwell',
    description: 'Is your codebase growing out of control and becoming difficult to maintain? Do you have too many teams working in that codebase causing scary merge conflicts? Maybe you want to write that new feature with Node.js but don\'t want to convert everything to javascript.\n\nWe\'ll explore some infrastructurual techniques we\'re using at Groupon to expand the scalability and maintainability of our applications. We\'ll see how those same techniques allowed us to rebuild our front-end web applications in Node.js without abandoning our entire legacy Rails application and continue to support our efforts as a polyglot organization.',
    going: '',
    time: '1pm-2pm' },
  ...
  { course_title: 'Continuous Delivery through Continuous Questioning',
    author: 'Joel Tosi',
    description: 'Continuous Delivery can be a substantial competitive advantage.  However, like all good ideas and concepts, if we turn off our thinking and just look to be the process, we will never truly realize the benefit.\n\nIn this session we will look at current delivery structures and how those can be morphed into continuous delivery.  Along this journey, we will question how do we know if we are doing the right thing?  Are we investing just to invest or is there a reason for our investment? Are we investing too much?   How do we strike a balance between continuous delivery, continuous learning, and proper spend?\n\nBring your questions and skepticism, let’s explore this space together.  Walk away with an understanding of how to start investing in automation, when to question your tests, and learn simple ways to inspect if you are investing in learning or investing in lines of tests.',
    going: '',
    time: '3:20pm-4:20pm' },
  { course_title: 'More Responsive, More Engaging with Couchbase Server and Node.js',
    author: 'Matt Ingenthron',
    description: 'Couchbase Server is the NoSQL document database for interactive applications.  Node.js is the platform for building fast, scalable network applications.  Just about everyone wants to build better responsive and more engaging experiences for their users, and we can help.\n\nIn this session, Matt Ingenthron and Brett Lawson will first talk about what is different about this generation of web applications.  The approach must consider the latency, throughput and interactivity demanded by users for social interaction across both mobile devices and browsers.  Then they will show how Node.js’s programming model makes writing systems to provide this kind of interactivity easy and how Couchbase Server and the Node.js Couchbase SDK support this with a flexible data model and easy scalability.\n\nCome to this session ready to read code, since a sample game platform will be the basis of a demonstration of these techniques in action.  Brett and Matt will show a sample game server, and key aspects of how the system is constructed for simplicity of data modeling, extensibility and scale.',
    going: '',
    time: '2:10pm-3:10pm' },
  { course_title: 'Systems Thinking, Deming, Drucker, oh my',
    author: 'Joel Tosi',
    description: 'This session will focus  on introducing Systems thinking with introductory statements / comments from Deming, Drucker, Senge, Pink, etc.\n\nThe focus of the session is not on technical takeaways so much as ways of thinking about your team, your organization, etc as a system and looking at addressing the system and not the symptoms.',
    going: '',
    time: '8:30am-9:30am' },
  ...
  { course_title: 'First year patterns: surviving and succeeding as a new developer',
    author: 'Patrick Flor',
    description: 'I\'d like to talk about the highs and lows of the first year on the job as a software engineer, and some practices and priorities that might help early-career developers cope with the pace of work, grow into their roles, keep learning, and maintain work-life balance.\n\nI think this talk could be useful to two audiences: upperclassmen and early-career developers currently in this phase of their career; as well as managers and apprenticeship/onboarding program designers, who might find something here to incorporate or at least consider when dealing with newer hires.',
    going: '',
    time: '2:10pm-3:10pm' },
  ...
  { course_title: 'Painless Asset Management with connect-assets',
    ...
    description: 'connect-assets is a transparent asset management package: it compiles, concatenates, minifies, and fingerprints your JavaScript, CSS, fonts, images, and the like to ensure that your site always looks its best, even when you deploy updates to cached files.\n\nAs the maintainer of the package, I’ll give a bit of history on the module and talk about why you’d want something like connect-assets. We’ll go through the basics of properly serving assets and write (live-code?!) an Express application using connect-assets.',
    going: '',
    time: '4:30pm-5:30pm' },
  { course_title: 'The top free tools for tackling ASP.NET performance',
    author: 'Ben Emmett',
    description: 'How do you know when it\'s time to work on performance? Where can you get the biggest gains? If you find a problem, how will you know how to fix it? What kind of improvements can you expect?\n\nThe free tooling in this area is terrific - the greatest challenge is knowing the best tools for the job. In this session, we\'ll look at each of the stages of finding and fixing performance issues in ASP.NET applications. We’ll pick the top 5 free tools and services out there - and maybe look at a couple of bonus techniques too, time permitting!\n\nAfter this talk, you\'ll have everything you need to make your site as fast as it can be.',
    going: '',
    time: '10:50am-11:50am' },
  ...
  { course_title: 'Introduction to Google Dart',
    author: 'Chad Adams',
    description: 'Welcome to Dart, an open-source, batteries-included developer platform for building structured HTML5 web apps.\n\nThis session will start HTML-stack developers on the path to learning the easy to use, yet object oriented, and highly scalable‎ Dart Language.  We will go over the language, the Dart Editor, Google\'s IDE for Dart files, Dartium - a custom version of Chrome that can run Dart files, and we will also go over building to JavaScript using Dart2JS.\n\n',
    going: '',
    time: '2:10pm-3:10pm' },
  ...
  { course_title: 'Introduction to iOS Development in .NET with Xamarin.iOS and Xamarin Studio',
    ...
    description: '\nHave you ever wondered what would be required to utilize your .NET development skills to build native iOS apps that take full advantage of the iPhone and iPad hardware?  Many developers think that iOS development is a concept limited only to those willing develop in Objective-C.  Thanks to the Xamarin.iOS (formerly MonoTouch), .NET developers can write applications in C# that compile to native iOS applications and have full access to the native Apple hardware.   This session will provide an overview of Xamarin.iOS framework, the development process it allows for, and will spend a significant amount of time CODING iOS APPS IN C#.\nTopics to be discussed:\n\n- Development environment requirements (yes, you will need a Mac)\n\n- Tips for getting started and learning resources\n\n- Capabilities of Xamarin.iOS vs. other mobile development platforms (including straight Objective-C)\n- Introduction to iOS concepts in Xamarin.iOS including common controls and navigation paradigm.\n\n- An overview of using X-Code to design iOS user interfaces.\n\n- Using Xamarin Studio (or MonoDevelop) as a development environment and how it compares to Visual Studio\n\n- Sharing code between a native .NET application and a Xamarin.iOS application\n\nWill we write code?  YES.  You will see a full iOS application written in C# utilizing Xamarin.iOS and Xamarin Studio.  \n\nEven if you are not immediately planning on building an iOS application, this session will be a great introduction to what would be required and what capabilities exist for .NET developers who may want to start considering the possibilities.',
    going: '',
    time: '9:40am-10:40am' },
  ...
  { course_title: 'DevOps: Getting Started with Puppet on Windows',
    author: 'Rob Reynolds',
    description: 'You keep hearing about DevOps and how awesome it is, if you have Linux. Well Windows can be awesome with DevOps, too. And it\'s just going to keep getting better. \nIf you are on Windows and you are even remotely interested in making things better, then you should come out and see what Puppet is all about and what it can do for your organization.',
    going: '',
    time: '4:30pm-5:30pm' },
  ...
  { course_title: 'Continuous Delivery',
    author: 'Jeff Fattic',
    description: 'Most companies are interested in reducing their cycle times nowadays. This promotes agility, but we want to be sure to not sacrifice quality as we streamline.\nIn this session, we\'ll dive into topics like release management, load testing, application monitoring, production debugging, and much more!',
    going: '',
    time: '8:30am-9:30am' },
  ...
  { course_title: 'Practical Category Theory',
    author: 'Jim Duey',
    description: 'Category Theory has been described as "generalized abstract nonsense". And it is exactly that abstractness that makes it something the working programmer should know. Writing software is mostly about managing complexity and the abstractions provided by CT are exactly what you need.\n\nThis talk will be an introduction to these abstractions with direct links to the types of complexity they allow you to manage. It\'s geared towards programmers who are experienced enough to know there must be a better way and want to find it.',
    going: '',
    time: '10:50am-11:50am' },
...
var saturdayCourses = [ { course_title: 'Lightweight Business Intelligence with Ruby',
    author: 'Coraline Ehmke',
  ...
  { course_title: 'TAD - Test after development - adding tests to brownfield code',
    author: 'Jim Sowers',
    description: 'This presentation will step through several techniques that help work unit testing and SOLID principles into a codebase in a way that helps alleviate the pain. It will not focus on what percentage the code coverage is but on how to test the areas that will give you the ability to sleep at night.\nThe code examples will be in .net with a bias toward some tools; ReSharper and NCrunch for example.',
    going: '',
    time: '1pm-2pm' },
  { course_title: 'Cache-Control and Last-Modified and ETag, oh my!',
    author: 'Andrew Dunkman',
    description: 'Ever wonder exactly what combination of Cache-Control, Last-Modified, Expires, ETag, Vary, and Pragma headers will keep your content cached by browsers just long enough? And what exactly is a HTTP 304 anyway?\n\nIn this talk, we’ll take a look around at the available HTTP caching headers, what their values mean, and how browsers and proxies react. We’ll cover the best practices on client cache invalidation, the benefits of sending a Not Modified response, and briefly talk about the changes in HTTP 2.0 (SPDY) around caching.',
    going: '',
    time: '1pm-2pm' },
  ...
  { course_title: 'Temporal correlation and complex event processing in JavaScript',
    author: 'James Nugent',
    description: 'Ever tried building a system to do complex event processing but ended up getting bogged down in all the infrastructure necessary? Or maybe you\'ve tried running temporal correlation queries from a SQL database and become very familiar with nested subqueries...\n\nIn this talk we\'ll look at the projections model in the Event Store, and how it can be used both for CEP without the fuss, and as a better way of approaching temporal queries, using only Javascript!',
    going: '',
    time: '1pm-2pm' },
  { course_title: 'Service Patterns in AngularJS',
    author: 'Jeremy Mason',
    description: 'This session will begin with a brief explanation of Angular $services and some basic usage, then we will deep dive into some advanced scenarios of how developers can stretch the power of $services to their limits. \n\nParticipants will walk away with an understanding of how to create, inject, and extend Angular services, and a new appreciation for managing dependencies in Javascript. \n\nI will assume that participants can follow code samples in Javascript, and some basic understanding of Angular helps, but is not required. ',
    going: '',
    time: '1pm-2pm' },
  ...
  { course_title: 'Testing inside, outside, upside down',
    author: 'Jon Harding',
    description: 'Regardless of your testing practices and strategies, we all want to improve the testability of the software which we develop.\n\nTo develop testable software, you often isolate and test parts of system.  Unless your system is designed to allow the isolation of the various parts so they can be observed and exercised, testing will be difficult.  We will discuss testable software and design patterns to help you increase testability.',
    going: '',
    time: '3:20pm-4:20pm' },
  ...
  { course_title: 'How to Land Your Next Job: You don\'t want to be the COBOL guy in the corner do you?',
    author: 'Nate Taylor',
    description: 'Let\'s face it, chances are the job you are at today will not be the job you retire from. In reality, the job you are at today will be but one of several on your resume. It\'s part of the nature of software development. New technologies, shifting focus, mis-managed companies, start-up culture can all play a role in a developer changing jobs throughout their adult life.\n\nEven though most of us will have several different employers, the process is still stressful. How do we know that we won\'t be just changing where our desk is? Trading our old job and problems for the exact same job and problems at a new location?\n\nWe\'ll talk about things you can do to prepare yourself for your future jobs. What are some (simple) things you might already be doing that will help you in the next job search?',
    going: '',
    time: '8:30am-9:30am' },
  ...
  { course_title: 'Docker for Developers',
    author: 'Paul Stack',
    description: '"Docker is an open-source project to easily create lightweight, portable, self-sufficient containers from any application. The same container that a developer builds and tests on a laptop can run at scale, in production, on VMs, bare metal, OpenStack clusters, public clouds and more." \n\nThis talk will demonstrate how docker can be used for developers in order to create a container based architecture. This will allow them to be able to upgrade individual pieces of their system (e.g. webserver, database, file system) without having to change the entire application server\n\nContainer based deployment is a great way to move into an environment of immutable infrastructure. This is a newer thought process that means we do not change our systems in production. Instead, we deploy entire new versions of the system. This is a another tool that will help us move towards continuous delivery\n\nDuring the session, Paul will demonstrate how to take an ASP.NET MVC application and run it on mono in a docker continer',
    going: '',
    time: '9:40am-10:40am' },
  ...
  { course_title: 'Moving Forward with Phonegap/Cordova Plugins',
    ...
    going: '',
    time: '1pm-2pm' },
  { course_title: 'Confessions of an Evangelist – Credibility',
    author: 'Mike Benkovich',
  ...
  { course_title: 'Ins and outs of the RDBMS database.',
    author: 'Paul Sears',
    description: 'Discussion on SQL fundamentals (ranging from properly ordering from clauses, equi, anti-joins, index hints, etc; including performance considerations).  Also, touching on explanation plans. \n Discussion on T-SQL and PL/SQL (considerations on when to use common table expressions, associative arrays, parallelism / partitioning , etc).  Considering when to flatten data to hit with relational SQL.\n Discussion on Oracle Advanced Queuing and SQL Server Broker Agent in line with event driven SOA.\n Key Differences in T-SQL and PL/SQL.',
    going: '',
    time: '2:10pm-3:10pm' },
  { course_title: 'Humble programmers’ reflections by example on unit tests, tdd and bdd',
    author: 'Bruce Meacham',
    description: 'We started with code and many bugs, evolved to cover our code with simple tests and bugs were prevented.  But the tests multiplied without purpose and we asked ourselves; “What are we testing and where exactly in this SDLC should it form?”  What if we test before ever writing a single line of code; brilliant… But what do we test without knowing what we’re building? It’s the proverbial chicken-or-the-egg.  User stories and business requirements are natural launch pad for writing good tests that write good code. \n We’ll flesh this approach with specific cases in C# with SpecFlow and Javascript with Cucumber and how this methodology transcends implementations.',
    going: '',
    time: '3:20pm-4:20pm' },
  ...
  { course_title: 'Exploring the JavaScript Multiverse',
    author: 'Dusty Burwell',
    description: 'For better or worse, JavaScript is basically everywhere these days. What started in the browser has reached back onto the server. You want JavaScript in your database? Well, golly, we can do that too. Now, you can even write a desktop application with JavaScript. Who needs a browser anyway?\n\nIn this session, we\'ll play with some nifty tech all powered by JavaScript. Haters need not apply.',
    going: '',
    time: '8:30am-9:30am' },
  { course_title: 'Introduction to Development on Android devices',
    author: 'Muljadi Budiman',
    description: 'Interested in Android development?  (Introductory) help is here!\n\nThis session will introduce developers on how to start developing for the Android platform.  It\'ll cover the basics of setting up the emulator, developing software using Eclipse, hops through XML Layouts with typical controls, responding to events, handle orientation changes, and trying to access some hardware devices.  All in all, a cursory & fast look at how you can start creating apps in the Android environment.',
    going: '',
    time: '10:50am-11:50am' },
